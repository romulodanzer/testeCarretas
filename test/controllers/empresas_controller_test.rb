...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, logotipo: @empresa.logotipo, nome: @empresa.nome } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, logotipo: @empresa.logotipo, nome: @empresa.nome } }
